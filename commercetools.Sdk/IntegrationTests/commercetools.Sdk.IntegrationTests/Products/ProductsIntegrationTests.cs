        ...
        public async Task UpdateProductRemoveAssetByVariantIdAndAssetId()
        {
            ...
            await WithUpdateableProduct(client,
                ...
                async product =>
                {
                    ...
                    var action = new RemoveAssetUpdateAction(variantId: masterVariantId, assetId: asset.Id,
                        assetKey: null, staged: false);
        ...
        public async Task UpdateProductSetAssetKeyByVariantId()
        {
            ...
            await WithUpdateableProduct(client,
                ...
                async product =>
                {
                    ...
                    var action =
                        new SetAssetKeyUpdateAction(variantId: masterVariantId, assetId: asset.Id, assetKey: key, staged: false);
